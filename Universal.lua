...
local window = library:new("星际虚影 | 通用功能 | "..identifyexecutor())
--
local Page1 = window:Tab("脚本主页",'16060333448')
local info = Page1:section("作者信息",true)
local playerinfo = Page1:section("玩家信息",true)
local Serverinfo = Page1:section("服务器",true)
--
...
--
info:Label("主作者:月星[虚穹星隐]，作者QQ2171633885")
info:Label("Script Version:V2 pro")
info:Label("一个咸鱼")
info:Label("定制脚本五元")
info:Label("合作者:皮脚本 XK脚本 禁漫中心 KingAdvanced 冷脚本")

playerinfo:Label("你的用户昵称:"..game.Players.LocalPlayer.DisplayName)
playerinfo:Label("你的用户名:"..game.Players.LocalPlayer.Character.Name)
playerinfo:Label("你的userid:"..game.Players.LocalPlayer.UserId)
playerinfo:Label("你的Hwid:"..game:GetService("RbxAnalyticsService"):GetClientId())
playerinfo:Label("你的国家:"..game:GetService("LocalizationService").RobloxLocaleId)
playerinfo:Label("你的账号年龄:"..game:GetService("Players").LocalPlayer.AccountAge)

local PingValue = Serverinfo:Label("Ping:"..math.round(Stats.Network.ServerStatsItem["Data Ping"]:GetValue()))
spawn(function()
while wait() do
pcall(function()
PingValue.Text = "Ping:"..math.round(Stats.Network.ServerStatsItem["Data Ping"]:GetValue())
end)
end
end)
local FPSValue = Serverinfo:Label("FPS:")
spawn(function()
while wait() do
pcall(function()
local currentFPS = math.floor(1 / tick())
FPSValue.Text = "FPS: " .. currentFPS
end)
end
end)
Serverinfo:Label("服务器ID:"..game.PlaceId)
Serverinfo:Label("服务器连接:https://www.roblox.com/games/start?placeId=" .. game.PlaceId .. "&launchData=" .. game.JobId)
Serverinfo:Label("服务器名称:"..game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name)
